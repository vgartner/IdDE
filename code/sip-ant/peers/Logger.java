...
public class Logger
{
    ...
    static
    {
        try
        {
            ...
            System.out.println("Arquivo log: " + LOG_FILE);
...
//            logWriter.flush();
//        }
        org.idde.util.Logger.debugInfo(message, message);
...
//        logWriter.flush();
//        }
        org.idde.util.Logger.debugError(message, message);
...
//            logWriter.flush();
//        }
        org.idde.util.Logger.debugError(message, " ERRO " + message.toString() + exception.getMessage());
    }
...
//            networkWriter.flush();
        org.idde.util.Logger.debugInfo(message, buf.toString());

...
public class MainFrameOriginal implements WindowListener, ActionListener {
    ...
    private EventManagerOriginal eventManager;

    public MainFrameOriginal() {
        Thread thread = new Thread(new Runnable() {
            public void run() {
                eventManager = new EventManagerOriginal(MainFrameOriginal.this);
            }
        });
        thread.start();
...
//        }
        String title = Utils.getPeersHome() + "Confirme o endereço SIP";

...
import org.idde.sip.peers.sip.core.useragent.UAS;
import org.idde.sip.peers.sip.syntaxencoding.SipHeaderFieldMultiValue;
...
public class Utils {
    ...
    public static final String DEFAULT_PEERS_HOME = Util.getIddeHomeDirectory();
